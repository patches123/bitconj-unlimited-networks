...
import org.bitcoin.networks.impl.WorkingNetworkParameters;
...
public class WalletTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OptionSpec<String> netFlag = parser.accepts("net").withRequiredArg().ofType(String.class).defaultsTo(NetworkEnum.MAIN.toString());
        ...
        switch (netFlag.value(options)) {
            ...
            case "REGTEST":
                ...
                break;
            default:
            	params = WorkingNetworkParameters.get();
            	chainFileName = new File("regtest.chain");
        }
