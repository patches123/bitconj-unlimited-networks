...
public class BtcFormatTest {
    ...
    public void prefixTest() { // prefix b/c symbol is prefixed
        ...
        assertEquals("à¸¿1.00", usFormat.format(COIN));
        assertEquals("à¸¿1.01", usFormat.format(101000000));
        assertEquals("â‚¥à¸¿0.01", usFormat.format(1000));
        assertEquals("â‚¥à¸¿1,011.00", usFormat.format(101100000));
        assertEquals("â‚¥à¸¿1,000.01", usFormat.format(100001000));
        assertEquals("Âµà¸¿1,000,001.00", usFormat.format(100000100));
        assertEquals("Âµà¸¿1,000,000.10", usFormat.format(100000010));
        assertEquals("Âµà¸¿1,000,000.01", usFormat.format(100000001));
        assertEquals("Âµà¸¿1.00", usFormat.format(100));
        assertEquals("Âµà¸¿0.10", usFormat.format(10));
        assertEquals("Âµà¸¿0.01", usFormat.format(1));
    }
    ...
    public void suffixTest() {
        ...
        // int
        assertEquals("1,00 à¸¿", deFormat.format(100000000));
        assertEquals("1,01 à¸¿", deFormat.format(101000000));
        assertEquals("1.011,00 â‚¥à¸¿", deFormat.format(101100000));
        assertEquals("1.000,01 â‚¥à¸¿", deFormat.format(100001000));
        assertEquals("1.000.001,00 Âµà¸¿", deFormat.format(100000100));
        assertEquals("1.000.000,10 Âµà¸¿", deFormat.format(100000010));
        assertEquals("1.000.000,01 Âµà¸¿", deFormat.format(100000001));
    }
    ...
    public void symbolCollisionTest() {
        ...
        for (int i = 0; i < locales.length; ++i) {
            ...
            if (cs.contains("à¸¿")) {
                ...
                assertTrue(coin.contains("Éƒ"));
                assertFalse(coin.contains("à¸¿"));
                String milli = bf.format(valueOf(10000));
                assertTrue(milli.contains("â‚¥Éƒ"));
                assertFalse(milli.contains("à¸¿"));
                String micro = bf.format(valueOf(100));
                assertTrue(micro.contains("ÂµÉƒ"));
                assertFalse(micro.contains("à¸¿"));
                BtcFormat ff = BtcFormat.builder().scale(0).locale(locales[i]).pattern("Â¤#.#").build();
                assertEquals("Éƒ", ((BtcFixedFormat)ff).symbol());
                assertEquals("Éƒ", ff.coinSymbol());
                coin = ff.format(COIN);
                assertTrue(coin.contains("Éƒ"));
                assertFalse(coin.contains("à¸¿"));
                BtcFormat mlff = BtcFormat.builder().scale(3).locale(locales[i]).pattern("Â¤#.#").build();
                assertEquals("â‚¥Éƒ", ((BtcFixedFormat)mlff).symbol());
                assertEquals("Éƒ", mlff.coinSymbol());
                milli = mlff.format(valueOf(10000));
                assertTrue(milli.contains("â‚¥Éƒ"));
                assertFalse(milli.contains("à¸¿"));
                BtcFormat mcff = BtcFormat.builder().scale(6).locale(locales[i]).pattern("Â¤#.#").build();
                assertEquals("ÂµÉƒ", ((BtcFixedFormat)mcff).symbol());
                assertEquals("Éƒ", mcff.coinSymbol());
                micro = mcff.format(valueOf(100));
                assertTrue(micro.contains("ÂµÉƒ"));
                assertFalse(micro.contains("à¸¿"));
            }
            if (cs.contains("Éƒ")) {  // NB: We don't know of any such existing locale, but check anyway.
                BtcFormat bf = BtcFormat.getInstance(locales[i]);
                String coin = bf.format(COIN);
                assertTrue(coin.contains("à¸¿"));
                assertFalse(coin.contains("Éƒ"));
                String milli = bf.format(valueOf(10000));
                assertTrue(milli.contains("â‚¥à¸¿"));
                assertFalse(milli.contains("Éƒ"));
                String micro = bf.format(valueOf(100));
                assertTrue(micro.contains("Âµà¸¿"));
                assertFalse(micro.contains("Éƒ"));
            }
        }
    }
    ...
    public void argumentTypeTest() {
        ...
        // Coin
        assertEquals("Âµà¸¿1,000,000.01", usFormat.format(COIN.add(valueOf(1))));
        // Integer
        assertEquals("Âµà¸¿21,474,836.47" ,usFormat.format(Integer.MAX_VALUE));
        assertEquals("(Âµà¸¿21,474,836.48)" ,usFormat.format(Integer.MIN_VALUE));
        // Long
        assertEquals("Âµà¸¿92,233,720,368,547,758.07" ,usFormat.format(Long.MAX_VALUE));
        assertEquals("(Âµà¸¿92,233,720,368,547,758.08)" ,usFormat.format(Long.MIN_VALUE));
        // BigInteger
        assertEquals("Âµà¸¿0.10" ,usFormat.format(java.math.BigInteger.TEN));
        assertEquals("à¸¿0.00" ,usFormat.format(java.math.BigInteger.ZERO));
        // BigDecimal
        assertEquals("à¸¿1.00" ,usFormat.format(java.math.BigDecimal.ONE));
        assertEquals("à¸¿0.00" ,usFormat.format(java.math.BigDecimal.ZERO));
        ...
        assertEquals("à¸¿0.00", usFormat.format(java.math.BigDecimal.valueOf(Double.MIN_VALUE)));
        assertEquals(
            "à¸¿340,282,346,638,528,860,000,000,000,000,000,000,000.00",
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        assertEquals(valueOf(200000000), us.parseObject("à¸¿2"));
        assertEquals(valueOf(200000000), us.parseObject("Éƒ2"));
        ...
        assertEquals(valueOf(200000000), us.parseObject("à¸¿2.0"));
        assertEquals(valueOf(200000000), us.parseObject("Éƒ2.0"));
        ...
        assertEquals(valueOf(200000000), usCoded.parseObject("à¸¿ 2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("Éƒ 2"));
        assertEquals(valueOf(200000000), usCoded.parseObject(" 2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("BTC 2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("XBT 2"));
        assertEquals(valueOf(202222420000000L), us.parseObject("2,022,224.20"));
        assertEquals(valueOf(202222420000000L), us.parseObject("à¸¿2,022,224.20"));
        assertEquals(valueOf(202222420000000L), us.parseObject("Éƒ2,022,224.20"));
        ...
        assertEquals(valueOf(200000), usCoded.parseObject("mà¸¿ 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("mÉƒ 2"));
        assertEquals(valueOf(200000), us.parseObject("mBTC2"));
        assertEquals(valueOf(200000), us.parseObject("mXBT2"));
        assertEquals(valueOf(200000), us.parseObject("â‚¥à¸¿2"));
        assertEquals(valueOf(200000), us.parseObject("â‚¥Éƒ2"));
        assertEquals(valueOf(200000), us.parseObject("â‚¥2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥BTC 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥XBT 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥BTC 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥XBT 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥à¸¿ 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥Éƒ 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥ 2"));
        assertEquals(valueOf(202222400000L), us.parseObject("â‚¥à¸¿2,022,224"));
        assertEquals(valueOf(202222420000L), us.parseObject("â‚¥Éƒ2,022,224.20"));
        assertEquals(valueOf(202222400000L), us.parseObject("mà¸¿2,022,224"));
        assertEquals(valueOf(202222420000L), us.parseObject("mÉƒ2,022,224.20"));
        assertEquals(valueOf(202222400000L), us.parseObject("â‚¥BTC2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("â‚¥XBT2,022,224"));
        ...
        assertEquals(valueOf(202222420000L), us.parseObject("â‚¥2,022,224.20"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("â‚¥à¸¿ 2,022,224"));
        assertEquals(valueOf(202222420000L), usCoded.parseObject("â‚¥Éƒ 2,022,224.20"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("mà¸¿ 2,022,224"));
        assertEquals(valueOf(202222420000L), usCoded.parseObject("mÉƒ 2,022,224.20"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("â‚¥BTC 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("â‚¥XBT 2,022,224"));
        ...
        assertEquals(valueOf(202222420000L), usCoded.parseObject("â‚¥ 2,022,224.20"));
        // Microcoins
        assertEquals(valueOf(435), us.parseObject("Âµà¸¿4.35"));
        assertEquals(valueOf(435), us.parseObject("uÉƒ4.35"));
        assertEquals(valueOf(435), us.parseObject("uà¸¿4.35"));
        assertEquals(valueOf(435), us.parseObject("ÂµÉƒ4.35"));
        assertEquals(valueOf(435), us.parseObject("uBTC4.35"));
        assertEquals(valueOf(435), us.parseObject("uXBT4.35"));
        assertEquals(valueOf(435), us.parseObject("ÂµBTC4.35"));
        assertEquals(valueOf(435), us.parseObject("ÂµXBT4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uBTC 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uXBT 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("ÂµBTC 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("ÂµXBT 4.35"));
        ...
        assertEquals(valueOf(-1), usCoded.parseObject("(Âµà¸¿ 0.01)"));
        assertEquals(valueOf(-10), us.parseObject("(ÂµBTC0.100)"));
        assertEquals(valueOf(-10), us.parseObject("(ÂµXBT0.100)"));

        // Same thing with addition of custom code, symbol
        us = BtcFormat.builder().locale(US).style(SYMBOL).symbol("Â£").code("XYZ").build();
        usCoded = BtcFormat.builder().locale(US).scale(0).symbol("Â£").code("XYZ").
                            pattern("Â¤ #,##0.00").build();
        // Coins
        assertEquals(valueOf(200000000), us.parseObject("XYZ2"));
        assertEquals(valueOf(200000000), us.parseObject("BTC2"));
        assertEquals(valueOf(200000000), us.parseObject("XBT2"));
        assertEquals(valueOf(200000000), us.parseObject("Â£2"));
        assertEquals(valueOf(200000000), us.parseObject("à¸¿2"));
        assertEquals(valueOf(200000000), us.parseObject("Éƒ2"));
        assertEquals(valueOf(200000000), us.parseObject("2"));
        ...
        assertEquals(valueOf(200000000), usCoded.parseObject("BTC 2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("XBT 2"));
        assertEquals(valueOf(200000000), us.parseObject("Â£2.0"));
        assertEquals(valueOf(200000000), us.parseObject("à¸¿2.0"));
        assertEquals(valueOf(200000000), us.parseObject("Éƒ2.0"));
        assertEquals(valueOf(200000000), us.parseObject("2.0"));
        ...
        assertEquals(valueOf(200000000), us.parseObject("BTC2.0"));
        assertEquals(valueOf(200000000), us.parseObject("XBT2.0"));
        assertEquals(valueOf(200000000), usCoded.parseObject("Â£ 2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("à¸¿ 2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("Éƒ 2"));
        assertEquals(valueOf(200000000), usCoded.parseObject(" 2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("XYZ 2"));
        ...
        assertEquals(valueOf(200000000), usCoded.parseObject("XBT 2"));
        assertEquals(valueOf(202222420000000L), us.parseObject("2,022,224.20"));
        assertEquals(valueOf(202222420000000L), us.parseObject("Â£2,022,224.20"));
        assertEquals(valueOf(202222420000000L), us.parseObject("à¸¿2,022,224.20"));
        assertEquals(valueOf(202222420000000L), us.parseObject("Éƒ2,022,224.20"));
        ...
        assertEquals(valueOf(200000), usCoded.parseObject("mBTC 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("mXBT 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("mÂ£ 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("mà¸¿ 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("mÉƒ 2"));
        assertEquals(valueOf(200000), us.parseObject("mXYZ2"));
        assertEquals(valueOf(200000), us.parseObject("mBTC2"));
        assertEquals(valueOf(200000), us.parseObject("mXBT2"));
        assertEquals(valueOf(200000), us.parseObject("â‚¥Â£2"));
        assertEquals(valueOf(200000), us.parseObject("â‚¥à¸¿2"));
        assertEquals(valueOf(200000), us.parseObject("â‚¥Éƒ2"));
        assertEquals(valueOf(200000), us.parseObject("â‚¥2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥XYZ 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥BTC 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥XBT 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥XYZ 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥BTC 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥XBT 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥Â£ 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥à¸¿ 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥Éƒ 2"));
        assertEquals(valueOf(200000), usCoded.parseObject("â‚¥ 2"));
        assertEquals(valueOf(202222400000L), us.parseObject("â‚¥Â£2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("â‚¥à¸¿2,022,224"));
        assertEquals(valueOf(202222420000L), us.parseObject("â‚¥Éƒ2,022,224.20"));
        assertEquals(valueOf(202222400000L), us.parseObject("mÂ£2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("mà¸¿2,022,224"));
        assertEquals(valueOf(202222420000L), us.parseObject("mÉƒ2,022,224.20"));
        assertEquals(valueOf(202222400000L), us.parseObject("â‚¥XYZ2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("â‚¥BTC2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("â‚¥XBT2,022,224"));
        ...
        assertEquals(valueOf(202222400000L), us.parseObject("mXBT2,022,224"));
        assertEquals(valueOf(202222420000L), us.parseObject("â‚¥2,022,224.20"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("â‚¥Â£ 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("â‚¥à¸¿ 2,022,224"));
        assertEquals(valueOf(202222420000L), usCoded.parseObject("â‚¥Éƒ 2,022,224.20"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("mÂ£ 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("mà¸¿ 2,022,224"));
        assertEquals(valueOf(202222420000L), usCoded.parseObject("mÉƒ 2,022,224.20"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("â‚¥XYZ 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("â‚¥BTC 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("â‚¥XBT 2,022,224"));
        ...
        assertEquals(valueOf(202222420000L), usCoded.parseObject("â‚¥ 2,022,224.20"));
        // Microcoins
        assertEquals(valueOf(435), us.parseObject("ÂµÂ£4.35"));
        assertEquals(valueOf(435), us.parseObject("Âµà¸¿4.35"));
        assertEquals(valueOf(435), us.parseObject("uÉƒ4.35"));
        assertEquals(valueOf(435), us.parseObject("uÂ£4.35"));
        assertEquals(valueOf(435), us.parseObject("uà¸¿4.35"));
        assertEquals(valueOf(435), us.parseObject("ÂµÉƒ4.35"));
        assertEquals(valueOf(435), us.parseObject("uXYZ4.35"));
        assertEquals(valueOf(435), us.parseObject("uBTC4.35"));
        assertEquals(valueOf(435), us.parseObject("uXBT4.35"));
        assertEquals(valueOf(435), us.parseObject("ÂµXYZ4.35"));
        assertEquals(valueOf(435), us.parseObject("ÂµBTC4.35"));
        assertEquals(valueOf(435), us.parseObject("ÂµXBT4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uXYZ 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uBTC 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uXBT 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("ÂµXYZ 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("ÂµBTC 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("ÂµXBT 4.35"));
        // fractional satoshi; round up
        ...
        assertEquals(valueOf(435), us.parseObject("uXBT4.345"));
        // negative with mu symbol
        assertEquals(valueOf(-1), usCoded.parseObject("ÂµÂ£ -0.01"));
        assertEquals(valueOf(-1), usCoded.parseObject("Âµà¸¿ -0.01"));
        assertEquals(valueOf(-10), us.parseObject("(ÂµXYZ0.100)"));
        assertEquals(valueOf(-10), us.parseObject("(ÂµBTC0.100)"));
        assertEquals(valueOf(-10), us.parseObject("(ÂµXBT0.100)"));
    ...
    public void parseMetricTest() throws ParseException {
        ...
        assertEquals(parseCoin("1"), cp.parseObject("à¸¿ 1.00"));
        assertEquals(parseCoin("1"), sp.parseObject("à¸¿1.00"));
        assertEquals(parseCoin("1"), cp.parseObject("Bâƒ¦ 1.00"));
        assertEquals(parseCoin("1"), sp.parseObject("Bâƒ¦1.00"));
        assertEquals(parseCoin("1"), cp.parseObject("Éƒ 1.00"));
        assertEquals(parseCoin("1"), sp.parseObject("Éƒ1.00"));
        // milli
        assertEquals(parseCoin("0.001"), cp.parseObject("mBTC 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("mBTC1.00"));
        assertEquals(parseCoin("0.001"), cp.parseObject("mà¸¿ 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("mà¸¿1.00"));
        assertEquals(parseCoin("0.001"), cp.parseObject("mBâƒ¦ 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("mBâƒ¦1.00"));
        assertEquals(parseCoin("0.001"), cp.parseObject("mÉƒ 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("mÉƒ1.00"));
        assertEquals(parseCoin("0.001"), cp.parseObject("â‚¥BTC 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("â‚¥BTC1.00"));
        assertEquals(parseCoin("0.001"), cp.parseObject("â‚¥à¸¿ 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("â‚¥à¸¿1.00"));
        assertEquals(parseCoin("0.001"), cp.parseObject("â‚¥Bâƒ¦ 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("â‚¥Bâƒ¦1.00"));
        assertEquals(parseCoin("0.001"), cp.parseObject("â‚¥Éƒ 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("â‚¥Éƒ1.00"));
        // micro
        assertEquals(parseCoin("0.000001"), cp.parseObject("uBTC 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uBTC1.00"));
        assertEquals(parseCoin("0.000001"), cp.parseObject("uà¸¿ 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uà¸¿1.00"));
        assertEquals(parseCoin("0.000001"), cp.parseObject("uBâƒ¦ 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uBâƒ¦1.00"));
        assertEquals(parseCoin("0.000001"), cp.parseObject("uÉƒ 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uÉƒ1.00"));
        assertEquals(parseCoin("0.000001"), cp.parseObject("ÂµBTC 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("ÂµBTC1.00"));
        assertEquals(parseCoin("0.000001"), cp.parseObject("Âµà¸¿ 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("Âµà¸¿1.00"));
        assertEquals(parseCoin("0.000001"), cp.parseObject("ÂµBâƒ¦ 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("ÂµBâƒ¦1.00"));
        assertEquals(parseCoin("0.000001"), cp.parseObject("ÂµÉƒ 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("ÂµÉƒ1.00"));
        // satoshi
        assertEquals(parseCoin("0.00000001"), cp.parseObject("uBTC 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("uBTC0.01"));
        assertEquals(parseCoin("0.00000001"), cp.parseObject("uà¸¿ 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("uà¸¿0.01"));
        assertEquals(parseCoin("0.00000001"), cp.parseObject("uBâƒ¦ 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("uBâƒ¦0.01"));
        assertEquals(parseCoin("0.00000001"), cp.parseObject("uÉƒ 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("uÉƒ0.01"));
        assertEquals(parseCoin("0.00000001"), cp.parseObject("ÂµBTC 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("ÂµBTC0.01"));
        assertEquals(parseCoin("0.00000001"), cp.parseObject("Âµà¸¿ 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("Âµà¸¿0.01"));
        assertEquals(parseCoin("0.00000001"), cp.parseObject("ÂµBâƒ¦ 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("ÂµBâƒ¦0.01"));
        assertEquals(parseCoin("0.00000001"), cp.parseObject("ÂµÉƒ 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("ÂµÉƒ0.01"));
        // cents
        ...
        assertEquals(parseCoin("0.01234567"), cp.parseObject("cà¸¿ 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("cà¸¿1.234567"));
        assertEquals(parseCoin("0.01234567"), cp.parseObject("cBâƒ¦ 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("cBâƒ¦1.234567"));
        assertEquals(parseCoin("0.01234567"), cp.parseObject("cÉƒ 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("cÉƒ1.234567"));
        assertEquals(parseCoin("0.01234567"), cp.parseObject("Â¢BTC 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("Â¢BTC1.234567"));
        assertEquals(parseCoin("0.01234567"), cp.parseObject("Â¢à¸¿ 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("Â¢à¸¿1.234567"));
        assertEquals(parseCoin("0.01234567"), cp.parseObject("Â¢Bâƒ¦ 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("Â¢Bâƒ¦1.234567"));
        assertEquals(parseCoin("0.01234567"), cp.parseObject("Â¢Éƒ 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("Â¢Éƒ1.234567"));
        // dekacoins
        ...
        assertEquals(parseCoin("12.34567"), cp.parseObject("daà¸¿ 1.234567"));
        assertEquals(parseCoin("12.34567"), sp.parseObject("daà¸¿1.234567"));
        assertEquals(parseCoin("12.34567"), cp.parseObject("daBâƒ¦ 1.234567"));
        assertEquals(parseCoin("12.34567"), sp.parseObject("daBâƒ¦1.234567"));
        assertEquals(parseCoin("12.34567"), cp.parseObject("daÉƒ 1.234567"));
        assertEquals(parseCoin("12.34567"), sp.parseObject("daÉƒ1.234567"));
        // hectocoins
        assertEquals(parseCoin("123.4567"), cp.parseObject("hBTC 1.234567"));
        assertEquals(parseCoin("123.4567"), sp.parseObject("hBTC1.234567"));
        assertEquals(parseCoin("123.4567"), cp.parseObject("hà¸¿ 1.234567"));
        assertEquals(parseCoin("123.4567"), sp.parseObject("hà¸¿1.234567"));
        assertEquals(parseCoin("123.4567"), cp.parseObject("hBâƒ¦ 1.234567"));
        assertEquals(parseCoin("123.4567"), sp.parseObject("hBâƒ¦1.234567"));
        assertEquals(parseCoin("123.4567"), cp.parseObject("hÉƒ 1.234567"));
        assertEquals(parseCoin("123.4567"), sp.parseObject("hÉƒ1.234567"));
        // kilocoins
        assertEquals(parseCoin("1234.567"), cp.parseObject("kBTC 1.234567"));
        assertEquals(parseCoin("1234.567"), sp.parseObject("kBTC1.234567"));
        assertEquals(parseCoin("1234.567"), cp.parseObject("kà¸¿ 1.234567"));
        assertEquals(parseCoin("1234.567"), sp.parseObject("kà¸¿1.234567"));
        assertEquals(parseCoin("1234.567"), cp.parseObject("kBâƒ¦ 1.234567"));
        assertEquals(parseCoin("1234.567"), sp.parseObject("kBâƒ¦1.234567"));
        assertEquals(parseCoin("1234.567"), cp.parseObject("kÉƒ 1.234567"));
        assertEquals(parseCoin("1234.567"), sp.parseObject("kÉƒ1.234567"));
        // megacoins
        assertEquals(parseCoin("1234567"), cp.parseObject("MBTC 1.234567"));
        assertEquals(parseCoin("1234567"), sp.parseObject("MBTC1.234567"));
        assertEquals(parseCoin("1234567"), cp.parseObject("Mà¸¿ 1.234567"));
        assertEquals(parseCoin("1234567"), sp.parseObject("Mà¸¿1.234567"));
        assertEquals(parseCoin("1234567"), cp.parseObject("MBâƒ¦ 1.234567"));
        assertEquals(parseCoin("1234567"), sp.parseObject("MBâƒ¦1.234567"));
        assertEquals(parseCoin("1234567"), cp.parseObject("MÉƒ 1.234567"));
        assertEquals(parseCoin("1234567"), sp.parseObject("MÉƒ1.234567"));
    }
    ...
    public void currencyCodeTest() {
        ...
        BtcFormat usCoded = BtcFormat.getCodeInstance(Locale.US);
        assertEquals("ÂµBTC 0.01", usCoded.format(1));
        ...
        assertEquals("0,01 ÂµBTC", frCoded.format(1));
        ...
        assertEquals("ÂµBTC 0,01", deCoded.format(1));
    ...
    public void autoDecimalTest() {
        ...
        assertEquals("à¸¿1", symbolZero.format(COIN));
        assertEquals("BTC 1", codedZero.format(COIN));
        assertEquals("Âµà¸¿1,000,000", symbolZero.format(COIN.subtract(SATOSHI)));
        assertEquals("ÂµBTC 1,000,000", codedZero.format(COIN.subtract(SATOSHI)));
        assertEquals("Âµà¸¿1,000,000", symbolZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("ÂµBTC 1,000,000", codedZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("Âµà¸¿999,999", symbolZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("ÂµBTC 999,999", codedZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("à¸¿1,000", symbolZero.format(COIN.multiply(1000)));
        assertEquals("BTC 1,000", codedZero.format(COIN.multiply(1000)));
        assertEquals("Âµà¸¿1", symbolZero.format(Coin.valueOf(100)));
        assertEquals("ÂµBTC 1", codedZero.format(Coin.valueOf(100)));
        assertEquals("Âµà¸¿1", symbolZero.format(Coin.valueOf(50)));
        assertEquals("ÂµBTC 1", codedZero.format(Coin.valueOf(50)));
        assertEquals("Âµà¸¿0", symbolZero.format(Coin.valueOf(49)));
        assertEquals("ÂµBTC 0", codedZero.format(Coin.valueOf(49)));
        assertEquals("Âµà¸¿0", symbolZero.format(Coin.valueOf(1)));
        assertEquals("ÂµBTC 0", codedZero.format(Coin.valueOf(1)));
        assertEquals("Âµà¸¿500,000", symbolZero.format(Coin.valueOf(49999999)));
        assertEquals("ÂµBTC 500,000", codedZero.format(Coin.valueOf(49999999)));

        assertEquals("Âµà¸¿499,500", symbolZero.format(Coin.valueOf(49950000)));
        assertEquals("ÂµBTC 499,500", codedZero.format(Coin.valueOf(49950000)));
        assertEquals("Âµà¸¿499,500", symbolZero.format(Coin.valueOf(49949999)));
        assertEquals("ÂµBTC 499,500", codedZero.format(Coin.valueOf(49949999)));
        assertEquals("Âµà¸¿500,490", symbolZero.format(Coin.valueOf(50049000)));
        assertEquals("ÂµBTC 500,490", codedZero.format(Coin.valueOf(50049000)));
        assertEquals("Âµà¸¿500,490", symbolZero.format(Coin.valueOf(50049001)));
        assertEquals("ÂµBTC 500,490", codedZero.format(Coin.valueOf(50049001)));
        assertEquals("Âµà¸¿500,000", symbolZero.format(Coin.valueOf(49999950)));
        assertEquals("ÂµBTC 500,000", codedZero.format(Coin.valueOf(49999950)));
        assertEquals("Âµà¸¿499,999", symbolZero.format(Coin.valueOf(49999949)));
        assertEquals("ÂµBTC 499,999", codedZero.format(Coin.valueOf(49999949)));
        assertEquals("Âµà¸¿500,000", symbolZero.format(Coin.valueOf(50000049)));
        assertEquals("ÂµBTC 500,000", codedZero.format(Coin.valueOf(50000049)));
        assertEquals("Âµà¸¿500,001", symbolZero.format(Coin.valueOf(50000050)));
        assertEquals("ÂµBTC 500,001", codedZero.format(Coin.valueOf(50000050)));

        BtcFormat codedTwo = BtcFormat.getCodeInstance(Locale.US, 2);
        BtcFormat symbolTwo = BtcFormat.getSymbolInstance(Locale.US, 2);
        assertEquals("à¸¿1.00", symbolTwo.format(COIN));
        assertEquals("BTC 1.00", codedTwo.format(COIN));
        assertEquals("Âµà¸¿999,999.99", symbolTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("ÂµBTC 999,999.99", codedTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("à¸¿1,000.00", symbolTwo.format(COIN.multiply(1000)));
        assertEquals("BTC 1,000.00", codedTwo.format(COIN.multiply(1000)));
        assertEquals("Âµà¸¿1.00", symbolTwo.format(Coin.valueOf(100)));
        assertEquals("ÂµBTC 1.00", codedTwo.format(Coin.valueOf(100)));
        assertEquals("Âµà¸¿0.50", symbolTwo.format(Coin.valueOf(50)));
        assertEquals("ÂµBTC 0.50", codedTwo.format(Coin.valueOf(50)));
        assertEquals("Âµà¸¿0.49", symbolTwo.format(Coin.valueOf(49)));
        assertEquals("ÂµBTC 0.49", codedTwo.format(Coin.valueOf(49)));
        assertEquals("Âµà¸¿0.01", symbolTwo.format(Coin.valueOf(1)));
        assertEquals("ÂµBTC 0.01", codedTwo.format(Coin.valueOf(1)));

        BtcFormat codedThree = BtcFormat.getCodeInstance(Locale.US, 3);
        BtcFormat symbolThree = BtcFormat.getSymbolInstance(Locale.US, 3);
        assertEquals("à¸¿1.000", symbolThree.format(COIN));
        assertEquals("BTC 1.000", codedThree.format(COIN));
        assertEquals("Âµà¸¿999,999.99", symbolThree.format(COIN.subtract(SATOSHI)));
        assertEquals("ÂµBTC 999,999.99", codedThree.format(COIN.subtract(SATOSHI)));
        assertEquals("à¸¿1,000.000", symbolThree.format(COIN.multiply(1000)));
        assertEquals("BTC 1,000.000", codedThree.format(COIN.multiply(1000)));
        assertEquals("â‚¥à¸¿0.001", symbolThree.format(Coin.valueOf(100)));
        assertEquals("mBTC 0.001", codedThree.format(Coin.valueOf(100)));
        assertEquals("Âµà¸¿0.50", symbolThree.format(Coin.valueOf(50)));
        assertEquals("ÂµBTC 0.50", codedThree.format(Coin.valueOf(50)));
        assertEquals("Âµà¸¿0.49", symbolThree.format(Coin.valueOf(49)));
        assertEquals("ÂµBTC 0.49", codedThree.format(Coin.valueOf(49)));
        assertEquals("Âµà¸¿0.01", symbolThree.format(Coin.valueOf(1)));
        assertEquals("ÂµBTC 0.01", codedThree.format(Coin.valueOf(1)));
    }
    ...
    public void negativeTest() throws Exception {
        ...
        assertEquals("à¸¿ -1,00", BtcFormat.getSymbolInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("BTC -1.00", BtcFormat.getInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("à¸¿-1.00", BtcFormat.getSymbolInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("(BTC 1.00)", BtcFormat.getInstance(US).format(COIN.multiply(-1)));
        assertEquals("(à¸¿1.00)", BtcFormat.getSymbolInstance(US).format(COIN.multiply(-1)));
        // assertEquals("BTC -à¥§.à¥¦à¥¦", BtcFormat.getInstance(Locale.forLanguageTag("hi-IN")).format(COIN.multiply(-1)));
        assertEquals("BTC -à¹‘.à¹�à¹�", BtcFormat.getInstance(new Locale("th","TH","TH")).format(COIN.multiply(-1)));
        assertEquals("Éƒ-à¹‘.à¹�à¹�", BtcFormat.getSymbolInstance(new Locale("th","TH","TH")).format(COIN.multiply(-1)));
    }
    ...
    public void attributeTest() throws Exception {
        ...
        assertTrue(codePat.contains("BTC") && ! codePat.contains("(^|[^à¸¿])à¸¿([^à¸¿]|$)") && ! codePat.contains("(^|[^Â¤])Â¤([^Â¤]|$)"));
        String symPat = BtcFormat.getSymbolInstance(Locale.US).pattern();
        assertTrue(symPat.contains("à¸¿") && !symPat.contains("BTC") && !symPat.contains("Â¤Â¤"));

        assertEquals("BTC #,##0.00;(BTC #,##0.00)", BtcFormat.getCodeInstance(Locale.US).pattern());
        assertEquals("à¸¿#,##0.00;(à¸¿#,##0.00)", BtcFormat.getSymbolInstance(Locale.US).pattern());
        assertEquals('0', BtcFormat.getInstance(Locale.US).symbols().getZeroDigit());
        // assertEquals('à¥¦', BtcFormat.getInstance(Locale.forLanguageTag("hi-IN")).symbols().getZeroDigit());
        // TODO will this next line work with other JREs?
//        assertEquals('à¹�', BtcFormat.getInstance(new Locale("th","TH","TH")).symbols().getZeroDigit());
    }

    @Ignore("non-determinism between OpenJDK versions")
    @Test
    public void toStringTest() {
        assertEquals("Auto-format à¸¿#,##0.00;(à¸¿#,##0.00)", BtcFormat.getSymbolInstance(Locale.US).toString());
        assertEquals("Auto-format à¸¿#,##0.0000;(à¸¿#,##0.0000)", BtcFormat.getSymbolInstance(Locale.US, 4).toString());
        ...
        assertEquals("Auto-format à¸¿#,##0.00;(à¸¿#,##0.00)",
        ...
        assertEquals("Auto-format BTC#,00à¸¿;BTC-#,00à¸¿",
                     BtcFormat.builder().style(SYMBOL).locale(GERMANY).pattern("Â¤Â¤#Â¤").build().toString());
        assertEquals("Coin-format BTC#,00à¸¿;BTC-#,00à¸¿",
                     BtcFormat.builder().scale(0).locale(GERMANY).pattern("Â¤Â¤#Â¤").build().toString());
        assertEquals("Millicoin-format BTC#.00à¸¿;BTC-#.00à¸¿",
                     BtcFormat.builder().scale(3).locale(US).pattern("Â¤Â¤#Â¤").build().toString());
    }
    ...
    public void patternDecimalPlaces() {
        ...
        BtcFormat f = BtcFormat.builder().locale(US).scale(3).pattern("Â¤Â¤ #.0").fractionDigits(3).build();
    ...
    public void builderTest() {
        ...
        built = BtcFormat.builder().pattern("Â¤#,####.#").style(CODE).locale(GERMANY).build();
        assertEquals("à¸¿-1,00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("Â¤Â¤ #,####.#").style(SYMBOL).locale(GERMANY).build();
        assertEquals("BTC -1,00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("Â¤Â¤##,###.#").scale(3).locale(US).build();
        assertEquals("mBTC1,000.00", built.format(COIN));
        built = BtcFormat.builder().pattern("Â¤ ##,###.#").scale(3).locale(US).build();
        assertEquals("â‚¥à¸¿ 1,000.00", built.format(COIN));

        try {
            BtcFormat.builder().pattern("Â¤Â¤##,###.#").scale(4).locale(US).build().format(COIN);
            fail("Pattern with currency sign and non-standard denomination should raise exception");
        } catch (IllegalStateException e) {}

        try {
            BtcFormat.builder().localizedPattern("Â¤Â¤##,###.#").scale(4).locale(US).build().format(COIN);
        ...
        assertEquals("Bâƒ¦1.00", built.format(COIN));
        ...
        assertEquals("à¸¿1.00", built.format(COIN));

        built = BtcFormat.builder().style(SYMBOL).symbol("B\u20e6").locale(US).build();
        assertEquals("â‚¥Bâƒ¦1.00", built.format(COIN.divide(1000)));
        built = BtcFormat.builder().style(CODE).code("XBT").locale(US).build();
        assertEquals("mXBT 1.00", built.format(COIN.divide(1000)));

        built = BtcFormat.builder().style(SYMBOL).symbol("B\u20e6").locale(US).build();
        assertEquals("ÂµBâƒ¦1.00", built.format(valueOf(100)));
        built = BtcFormat.builder().style(CODE).code("XBT").locale(US).build();
        assertEquals("ÂµXBT 1.00", built.format(valueOf(100)));

        /* The prefix of a pattern can have number symbols in quotes.
         * Make sure our custom negative-subpattern creator handles this. */
        built = BtcFormat.builder().pattern("'#'Â¤#0").scale(0).locale(US).build();
        assertEquals("#à¸¿-1.00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("'#0'Â¤#0").scale(0).locale(US).build();
        assertEquals("#0à¸¿-1.00", built.format(COIN.multiply(-1)));
        // this is an escaped quote between two hash marks in one set of quotes, not
        // two adjacent quote-enclosed hash-marks:
        built = BtcFormat.builder().pattern("'#''#'Â¤#0").scale(0).locale(US).build();
        assertEquals("#'#à¸¿-1.00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("'#0''#'Â¤#0").scale(0).locale(US).build();
        assertEquals("#0'#à¸¿-1.00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("'#0#'Â¤#0").scale(0).locale(US).build();
        assertEquals("#0#à¸¿-1.00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("'#0'E'#'Â¤#0").scale(0).locale(US).build();
        assertEquals("#0E#à¸¿-1.00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("E'#0''#'Â¤#0").scale(0).locale(US).build();
        assertEquals("E#0'#à¸¿-1.00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("E'#0#'Â¤#0").scale(0).locale(US).build();
        assertEquals("E#0#à¸¿-1.00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("E'#0''''#'Â¤#0").scale(0).locale(US).build();
        assertEquals("E#0''#à¸¿-1.00", built.format(COIN.multiply(-1)));
        ...
        assertEquals(a, b);
        assertEquals(a.hashCode(), b.hashCode());
        a = BtcFormat.builder().scale(3).pattern("Â¤#.#").build();
        b = BtcFormat.builder().scale(3).pattern("Â¤#.#").build();
        assertEquals(a, b);
        assertEquals(a.hashCode(), b.hashCode());
        a.format(COIN.multiply(1000000));
        assertEquals(a, b);
